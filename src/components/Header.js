  ...
  return (
    <header className="bg-gray-900">
      ...
      <nav className={headerStyles.navbar}>
        <ul className={headerStyles.navbarNav}>
          <li className={headerStyles.logo}>
            <Link
              ...
              to="/"
            >
              <span className={(headerStyles.linkText, headerStyles.logoText)}>
                Gatsby
              </span>
              <svg
                aria-hidden="true"
          ...
          <li className={headerStyles.navItem}>
            ...
            >
              ...
              <span className={headerStyles.linkText}>Blog</span>
            </Link>
          </li>
          <li className={headerStyles.navItem}>
            <Link
            ...
            >
              ...
              <span className={headerStyles.linkText}>About</span>
            </Link>
          </li>
          <li className={headerStyles.navItem}>
            <Link
            ...
            >
              ...
              <span className={headerStyles.linkText}>Contact</span>
            </Link>
          </li>
          <li className={headerStyles.navItem}>
            <Link className={headerStyles.navLink} to="/">
              ...
              <span className={headerStyles.linkText}>Light</span>
            </Link>
          </li>
        </ul>
      </nav>
